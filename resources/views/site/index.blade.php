                    ...
                    <div class="col-lg-4 col-md-7">
                        <div class="single-service d-flex">
                            ...
                            <div class="shape shape-5">
                                <img src="{{asset('assets/images/shape/shape-5.svg')}}" alt="shape">
                            </div>
                        </div> <!-- single service -->
                    </div>
                </div> <!-- row -->
        ...
        <div class="container">
            ...
            <div class="row grid">
                <div class="col-lg-4 col-sm-6 grid-item apps creative laptop">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{asset('assets/images/protfolio-1.jpg')}}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{asset('assets/images/protfolio-1.jpg')}}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item branding creative">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{asset('assets/images/protfolio-2.jpg')}}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{asset('assets/images/protfolio-2.jpg')}}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item apps branding product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{asset('assets/images/protfolio-3.jpg')}}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{asset('assets/images/protfolio-3.jpg')}}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item laptop product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{asset('assets/images/protfolio-5.jpg')}}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{asset('assets/images/protfolio-5.jpg')}}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item branding creative">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{asset('assets/images/protfolio-4.jpg')}}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{asset('assets/images/protfolio-4.jpg')}}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item apps laptop product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{asset('assets/images/protfolio-6.jpg')}}" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{asset('assets/images/protfolio-6.jpg')}}">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-30 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.4s">
                        <div class="blog-image">
                            <a href="blog-details.html"><img src="{{asset('assets/images/news-1.jpg')}}" alt="news"></a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-30 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.7s">
                        <div class="blog-image">
                            <a href="blog-details.html"><img src="{{asset('assets/images/news-2.jpg')}}" alt="news"></a>
                        </div>
                        <div class="blog-content">
                            <h4 class="blog-title"><a href="blog-details.html">Nulla eget urna at tortor  turpi feugiat tristique in sit.</a></h4>
                            <div class="blog-author d-flex align-items-center">
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-30 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="1s">
                        <div class="blog-image">
                            <a href="blog-details.html"><img src="{{asset('assets/images/news-3.jpg')}}" alt="news"></a>
                        </div>
                        <div class="blog-content">
                            <h4 class="blog-title"><a href="blog-details.html">Nulla eget urna at tortor  turpi feugiat tristique in sit.</a></h4>
                            <div class="blog-author d-flex align-items-center">
